...
{ 
 ?>
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img"><a href="kost-details.php?vhid=<?php echo htmlentities($result['id_mobil']);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result['image1']);?>" class="img-responsive" alt="Image" /> </a> 
          </div>
     ...
     <aside class="col-md-3 col-md-pull-9">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-home" aria-hidden="true"></i>Baru Ditambahkan</h5>
          </div>
