      ...
      <div class="row">
        <div class=" col-md-push-6 ">
          <div class=" col-md-pull-6">
            <font color="white">Copyright Imam Adli &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> <a expr:href='data:blog.homepageUrl'><data:blog.title/></a>. All rights reserved.</font>
          </div>
        </div>
      </div>
    </div>
