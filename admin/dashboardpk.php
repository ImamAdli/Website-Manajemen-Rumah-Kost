									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												...
												?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($namakost);?></div>
													<div class="stat-panel-title text-uppercase">Total Lokasi Kost</div>
												</div>
											</div>
											<a href="namakost.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
