								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
										...
										if ($_SESSION['alogin'] == 'admin') {
											...
											AND nama_kost.id_namakost=kost.id_namakost AND users.email=booking.email ORDER BY booking.kode_booking DESC";
										} else {
											$sqlsewa = "SELECT * FROM booking,kost,nama_kost,users WHERE booking.id_kamarkost=kost.id_kamarkost
											AND nama_kost.id_namakost=kost.id_namakost AND users.email=booking.email AND nama_kost.email='$logpk' ORDER BY booking.kode_booking DESC";
										}
