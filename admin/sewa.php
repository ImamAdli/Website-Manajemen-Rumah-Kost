	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Riwayat Penyewaan Kost</h2>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
										...
										if ($_SESSION['alogin'] == 'admin') {
											...
											AND pemilik_kost.id_pemilik=kamar_kost.id_pemilik AND users.email=booking.email ORDER BY booking.kode_booking DESC";
										} else {
											$sqlsewa = "SELECT * FROM booking,kamar_kost,pemilik_kost,users WHERE booking.id_kamar=kamar_kost.id_kamar
											AND pemilik_kost.id_pemilik=kamar_kost.id_pemilik AND users.email=booking.email AND pemilik_kost.email='$logpk' ORDER BY booking.kode_booking DESC";
										}
