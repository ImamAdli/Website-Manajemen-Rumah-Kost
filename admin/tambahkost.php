							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<label class="col-sm-2 control-label">Tipe Sewa<span style="color:red">*</span></label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											...
											<option value="Bensin">Didalam</option>
											<option value="Diesel">Diluar</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<select class="form-control" name="ac" required>
											<option value=""> == Pilih Fasilitas == </option>
											<option value="Bensin">Ada</option>
											<option value="Diesel">Tidak Ada</option>
										</select>
										</div>
									</div>
									<div class="hr-dashed"></div>
									...
									<div class="form-group">
										<div class="col-sm-4">
											Gambar 4<span style="color:red">*</span><input type="file" name="img4" accept="image/*">
										</div>
										<div class="col-sm-4">
