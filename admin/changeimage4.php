...
<head>
	...
	<title>Narty Boarding House | Admin Update Image 4</title>
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<label class="col-sm-4 control-label">Gambar Mobil 4 Sekarang</label>
												...
												?>
												<div class="col-sm-8">
													<img src="img/kostimages/<?php echo htmlentities($result['image4']);?>" width="300" height="200" style="border:solid 1px #000">
												</div>
											<?php }?>
											</div>
