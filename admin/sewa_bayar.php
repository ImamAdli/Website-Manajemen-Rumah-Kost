	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Menunggu Pembayaran Sewa Kost</h2>
										...
										<tbody>
											<?php
												...
												if ($_SESSION['alogin'] == 'admin') {										
													...
													AND pemilik_kost.id_pemilik=kamar_kost.id_pemilik AND users.email=booking.email AND status='Menunggu Pembayaran' 
													ORDER BY booking.kode_booking DESC";
												} else{
													$sqlsewa = "SELECT booking.*,kamar_kost.*,pemilik_kost.*,users.* FROM booking,kamar_kost,pemilik_kost,users WHERE booking.id_kamar=kamar_kost.id_kamar
													AND pemilik_kost.id_pemilik=kamar_kost.id_pemilik AND users.email=booking.email AND status='Menunggu Pembayaran' AND pemilik_kost.email='$logpk'
													ORDER BY booking.kode_booking DESC";
												}
