								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sqlsewa = "SELECT booking.*,kost.*,nama_kost.*,users.* FROM booking,kost,nama_kost,users WHERE booking.id_kamarkost=kost.id_kamarkost
													AND nama_kost.id_namakost=kost.id_namakost AND users.email=booking.email AND status='Menunggu Pembayaran' 
													ORDER BY booking.kode_booking DESC";
										} else{
											$sqlsewa = "SELECT booking.*,kost.*,nama_kost.*,users.* FROM booking,kost,nama_kost,users WHERE booking.id_kamarkost=kost.id_kamarkost
											AND nama_kost.id_namakost=kost.id_namakost AND users.email=booking.email AND status='Menunggu Pembayaran' AND nama_kost.email='$logpk'
											ORDER BY booking.kode_booking DESC";
										}
