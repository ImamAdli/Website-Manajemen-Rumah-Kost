			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Kelola Kost</h2>
						
						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Daftar nama_kost</div>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php 
										...
										<tr align="center">
											...
											<td><?php echo htmlentities($result['rekening']);?></td>
											...
											<td><a href="namakostedit.php?id=<?php echo $result['id_namakost'];?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
